...
<head>
  ...
  <title> Sistema Vendamaiss</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark barra ">
    <a class="navbar-brand" href="#">Vendamaiss</a>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3 menu">
        ...
        <ul class="menu">
          <li><a href="./principal.html" class="menu-item"> <i class="fa-solid fa-user-large"></i> Usuário </a> </li>
          <li><a href="./cidade.html" class="menu-item"> <i class="fa-solid fa-city"></i> Cidade </a> </li>
          <li><a href="./cliente.html" class="menu-item"> <i class="fa-solid fa-people-group"></i> Cliente </a> </li>
          <li><a href="./funcionario.html" class="menu-item"> <i class="fa-solid fa-user-tie"></i> funcionario </a>
          </li>
          <li><a href="./produto.html" class="menu-item"> <i class="fa-solid fa-box-open"></i> Produto </a> </li>
          <li><a href="./venda.html" class="menu-item"> <i class="fa-solid fa-basket-shopping"></i> Venda </a> </li>
            ...
            $resultado= mysqli_query($conexao,$sql);
              ...
              ?>
                ...
                <tr>
                  ...
                  <a href="<?php ECHO './usuario/excluir.php?id=' .$coluna['id'] ?>"> <i class="fa-solid fa-trash" style="color: red;"></i> </a>
                  </td>
                </tr>
