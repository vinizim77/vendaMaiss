...
<head>
    ...
    <link rel="stylesheet" href="./rescursos/estilo.css">
...
<div class="col-md-3 menu">
    <ul class="menu">
            <li><a href="./principal.html" class="menu-item"><i class="fa-solid fa-user"></i>usuario</a></li>
...
<script src="./rescursos/scripit.js"></script>
</body>
</html>